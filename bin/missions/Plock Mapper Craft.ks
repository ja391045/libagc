...
UNTIL runstage:stage > max_runstage {
    IF runstage:stage = 0 {
        ...
        SET _depart TO TIMESTAMP(10, 94, 5, 58, 13).
        SET _dp_node TO NODE(_depart, 0, -269.2, 2618.8).
        ADD _dp_node.
        runstage:bump().
        ...
        mnv:node:do(240, TRUE, FALSE, 0, TRUE, staging:algorithm:flameOut, SHIP:FACING:ROLL, 2.284).
        runstage:bump().
    }
    runstage:preserve().
    WAIT 1.
