...
UNTIL runstage:stage > max_runstage {
    IF runstage:stage = 0 {
        ...
        WAIT UNTIL SHIP:ORBIT:APOAPSIS > 70000.
        runstage:bump().
        ...
        SET _depart TO TIMESTAMP(9, 147, 2, 59, 06).
        ...
        mnv:node:do(90, TRUE, FALSE, 0, TRUE, staging:algorithm:flameOut, SHIP:FACING:ROLL, 2.284).
        runstage:bump().
    }
    runstage:preserve().
    WAIT 1.
