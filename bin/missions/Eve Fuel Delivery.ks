...
//      (altitude, heading, throttle percent)
        ...
        launch:rocket:go(profile, 100000, TRUE, 1, 5, staging:algorithm:flameOut@, LIST(4, 3)).
        runstage:bump().
        ...
        SET _depart TO TIMESTAMP(10, 133, 00, 50, 19).
        SET _dp_node TO NODE(_depart, 0, 970.4, 925.1).
        ADD _dp_node.
        runstage:bump().
